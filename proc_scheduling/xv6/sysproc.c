...
int
sys_wait_stat(void){
    int* wtime; //clock ticks during proc wait
    int* rtime; //clock ticks during proc run
    int* iotime; //clock ticks during proc waiting i/o
    int* status; //pid of terminated child proc, -1 for failure
    int pid;
